<div class="navbar" style="background-color: grey; width:100%;">
    <div class="container d-flex justify-content-between">
        ...
        <a href="/" class="navbar-brand d-flex align-items-center" style="color: black">
         <img src="/bbayoulogo.ico">
            <strong>BBAYOU</strong>
        </a>

        <a href="/giftcon" style="color: black">
            <strong>GIFTCON</strong>
        </a>

        <a href="/board/free" style="color: black; margin-left:10px;">
            <strong>자유게시판</strong>
        </a>


        <a href="/board/humor" style="color: black; margin-left:10px;">
            <strong>유머게시판</strong>
        </a>


        <a href="/board/game" style="color: black; margin-left:10px;">
            <strong>게임게시판</strong>
        </a>


        <a href="/board/sport" style="color: black; margin-left:10px;">
            <strong>스포츠게시판</strong>
        </a>

        @if(Auth::check())
        <a href="/giftcon/mygiftcons" style="color: #F27405; margin-left:10px;">
            <strong>내 기프티콘</strong>
        </a>

        @endif
        <div class="aa-input-container" id="aa-input-container" style="margin-left:20px;">
            <input type="search" id="aa-search-input" class="aa-input-search" placeholder="" name="search"
                autocomplete="off"  style="border-radius: 50px; width:180px; height:35px;"/>
        ...
        <div class="ml-auto">
            <div class="dropdown">
                <button class="btn"  > <a href="#" style="color : black;"> <strong>{{ Auth::user()->name}}님 안녕하세요!</strong> </a></button>
            ...
            <a href="/logout">
                <strong style="color: #F27405; margin-left:30px">로그아웃</strong>
            </a>
    ...
    autocomplete('#aa-search-input', {}, [{
            ...
            templates: {
                ...
                suggestion({
                  ...
                  console.log(_highlightResult.board_id.value);
